...
def main(username, scope, clientID, clientSecret, redirectURI, path):    
    ...
    while True:
        ...
        time.sleep((spotify.current_user_playing_track()['item']['duration_ms']/1000) - 6) #Stop us from getting rate limited from spotify API (It just waits for the song to end)
